...
export default function CameraWidget({ stream, active }) {
    ...
    return (
        ...
        >
            <div className="relative w-48 h-48 md:w-64 md:h-64 bg-white/10 rounded-[2.5rem] border border-white/20 shadow-[0_30px_80px_rgba(0,0,0,0.5)] flex flex-col overflow-hidden">
                {/* Video Content */}
            ...
            {/* Context Tooltip */}
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-black/80 px-4 py-1.5 rounded-full border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
